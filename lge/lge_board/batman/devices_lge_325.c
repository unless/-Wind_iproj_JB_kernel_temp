...
#define INT_UART8DM_IRQ    GSBI8_UARTDM_IRQ
#endif
/* PRNG device */
...
#define INT_UART10DM_IRQ    GSBI10_UARTDM_IRQ
#endif
...
#endif
/*                               */
#ifdef CONFIG_BATMAN_VZW_POWER_ON_OFF
#ifdef CONFIG_LGE_MDM_PMIC_8028
#include <mach/msm_xo.h>
static int __first_boot = 1;
#endif
#endif
...
#endif
#ifdef CONFIG_LGE_IRDA
static struct resource msm_uart_gsbi8_resources[] = {
	{
...
struct platform_device msm_device_uart_gsbi8 = {
	.name	= "msm_serial_hsl",
	.id	= 4,
	.num_resources	= ARRAY_SIZE(msm_uart_gsbi8_resources),
	.resource	= msm_uart_gsbi8_resources,
};
#endif

#ifdef CONFIG_LGE_FELICA
static struct resource msm_uart_gsbi10_resources[] = {
       {
    ...
    {
        .start  = INT_UART10DM_IRQ,
        .end    = INT_UART10DM_IRQ,
        .flags  = IORESOURCE_IRQ,
    },
    {
        /* GSBI 10 is UART_GSBI10 */
...
struct platform_device msm_device_uart_gsbi10 = {
    .name   = "msm_serial_hsl",
    .id = 3,
    .num_resources  = ARRAY_SIZE(msm_uart_gsbi10_resources),
    .resource   = msm_uart_gsbi10_resources,
};
#endif

#if defined (CONFIG_LGE_TOUCH_SYNAPTICS_325) || defined (CONFIG_LGE_TOUCHSCREEN_SYNAPTICS_RMI4_I2C)
...
static struct resource gsbi11_qup_spi_resources[] = {
	...
	// Qualcomm SPI DMA patch for 1Seg 2011-09-27 taew00k.kang [start]
	{
		.name	= "spidm_channels",
		.start	= 24,	//5,
		.end	= 25,	//6,
	...
	// Qualcomm SPI DMA patch for 1Seg 2011-09-27 taew00k.kang [end]
};
