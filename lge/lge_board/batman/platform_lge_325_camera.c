...
/* MT9E013 Main Camera - 8M Bayer Camera*/
#define GPIO_CAM_MCLK						32
#define GPIO_CAM_I2C_SDA					47
#define GPIO_CAM_I2C_SCL					48
#define GPIO_8M_CAM_RESET_N					157
#define GPIO_CAM_WP						94
#ifdef CONFIG_LGE_SENSOR_MT9E013
#define I2C_ADDR_MT9E013					0x6C>>2
#endif
#define CAM_I2C_SLAVE_ADDR				I2C_ADDR_MT9E013
...
#elif defined(CONFIG_MACH_LGE_325_BOARD_SKT) || defined(CONFIG_MACH_LGE_325_BOARD_DCM)
...
#define I2C_ADDR_MT9M114					0x48>>1
#endif
#define VT_CAM_I2C_SLAVE_ADDR				I2C_ADDR_MT9M114
...
static uint32_t camera_on_gpio_table_mt9e013[] = {
	GPIO_CFG(GPIO_CAM_MCLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(GPIO_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
...
#ifdef CONFIG_LGE_SENSOR_MT9E013
static int32_t ext_power_ctrl_mt9e013 (int enable)
{
	int32_t rc = 0;

	unsigned extra_gpio = GPIO_8M_CAM_RESET_N;
	if (enable) {
		rc = gpio_request(extra_gpio, "mt9e013_reset_n");
...
static struct msm_camera_gpio_conf gpio_conf_mt9e013 = {
	...
	.camera_on_table = camera_on_gpio_table_mt9e013,
	.camera_on_table_size = ARRAY_SIZE(camera_on_gpio_table_mt9e013),
	.gpio_no_mux = 1,
};

static struct camera_vreg_t msm_cam_vreg_mt9e013[] = {
	{"8058_l1", REG_LDO, 1200000, 1200000, -1},
...
static struct msm_camera_sensor_platform_info sensor_board_info_mt9e013 = {
	.mount_angle	= 90, //270
	.cam_vreg = msm_cam_vreg_mt9e013,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg_mt9e013),
	.gpio_conf = &gpio_conf_mt9e013,
	.ext_power_ctrl = ext_power_ctrl_mt9e013,
};
#endif
...
static struct i2c_board_info lge_camera_boardinfo[] __initdata = {
	#ifdef CONFIG_LGE_SENSOR_MT9E013
	{
		I2C_BOARD_INFO("mt9e013", CAM_I2C_SLAVE_ADDR),
...
void __init i2c_register_camera_info(void){
	...
	printk(KERN_EMERG "[CAMERA/+]i2c_register_camera_info\n");
