...
#include "timpani_profile_8x60_cayman_lgu.h"
...
static wmCodecCmd seq_lin_to_headset[] = 
{
    ...
    {0x2F, 0x0000},
    {0x30, 0x0000},
    {0x1C, 0x0133}, //refer to page 26
    {0x1D, 0x0133}, //refer to page 26  
    {0x16, 0x0000},
    {0x46, 0x0100},
    {0x49, 0x0100}
};
...
static wmCodecCmd seq_lin_to_headset_spkout[] = 
{
    ...
    {0x22, 0x0000}, // 0dB
    {0x25, 0x0178}, // 12dB(178}, 9dB(170}, 7.5dB(168}, 6dB(160}, 4.5dB(158}, 3dB(150}, 1.5dB(148}, 0dB(140)
    {0x26, 0x0132}, // refer to page 26  
    {0x2D, 0x0040},
    {0x2E, 0x0010},	
    {0x03, 0x0138},
    {0x2F, 0x0000},	
    {0x30, 0x0000},	
    {0x1C, 0x011F}, //refer to page 26
    {0x1D, 0x011F}, //refer to page 26    
    {0x16, 0x0000},	
    {0x46, 0x0100},	
    {0x49, 0x0100}
};
...
static struct adie_codec_action_unit iheadset_mic_acs_tx_osr256_actions[] =
	HEADSET_TX_MONO_PRI_OSR_256_ACS;
...
#ifdef CONFIG_LGE_AUDIO_AMP_WM9093
        //                               
        // MOD : for TD:WBT_12 452623, 452624, 452625
        if(token)	//                                                     
...
//                               
// DEL : for TD:WBT_12 452623, 452624, 452625
//    *data_len  = buff_len;
