...
static struct touch_platform_data  i_lgu_ts_data = {
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
    ...
    RPM_LDO(PM8058_L2,  0, 1, 0, 0, 0, LDO300HMIN), /* NC  */
	...
	RPM_LDO(PM8058_L14, 0, 0, 0, 2900000, 2900000, LDO300HMIN), /* +2V9_MICRO_SD */
...
#if 0 //                                       
	RPM_LDO(PM8058_L17, 0, 1, 0, 3000000, 3000000, LDO150HMIN), /* +3V0_TOUCH */
#else
	RPM_LDO(PM8058_L17, 0, 1, 0, 2850000, 2850000, LDO150HMIN), /* +2V85_GPS */
#endif
	RPM_LDO(PM8058_L18, 0, 1, 1, 2200000, 2200000, LDO150HMIN), /* +2V2_XOADC_REF */
	RPM_LDO(PM8058_L19, 0, 1, 0, 2850000, 2850000, LDO150HMIN), /* +3V0_TOUCH */
	RPM_LDO(PM8058_L20, 0, 1, 0, 1800000, 1800000, LDO150HMIN), /* +1V8_RF_XO */
	RPM_LDO(PM8058_L21, 1, 1, 0, 1200000, 1200000, LDO150HMIN), /* +1V1_MSM_PLL */
	...
	RPM_SMPS(PM8901_S4, 0, 1, 0, 1225000, 1225000,   FTS_HMIN, 1p60), /* +1V2_MSM_P1 */
...
#ifdef CONFIG_LGE_PMIC8058_REGULATOR /* lsu_test */
	RPM_PC(PM8058_L0,   0, SLEEP_B, RPM_VREG_PIN_CTRL_NONE),
#else
...
//                                                        AOUT_CTRL_ENABLE),
		...
		PM8058_MPP_INIT(XOADC_MPP_8, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH5,
							AOUT_CTRL_DISABLE),
                PM8058_MPP_INIT(XOADC_MPP_9, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH7,
                                                        AOUT_CTRL_DISABLE),
#if 0
		PM8058_MPP_INIT(XOADC_MPP_10, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH7,
							AOUT_CTRL_DISABLE),
...
#define HPH_DETECT_N                    18  // PM8058_GPIO 19
#define HPH_KEY_INT                     19  // PM8058_GPIO 20
#define WCA_AUDIO_RESET_N               20  // PM8058_GPIO 21
#define MICRO_SD_CARD_DETECT_N          21  // PM8058_GPIO 22
#define PMIC_SSBI_CLK                   38  // PM8058_GPIO 39
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
                 ...
                 { /* HPH_DETECT_N - GPIO19*/
                         PM8058_GPIO_PM_TO_SYS(HPH_DETECT_N),
                         {
                                 .direction              = PM_GPIO_DIR_IN,
                 ...
                 { /* HPH_KEY_INT - GPIO20*/
                         PM8058_GPIO_PM_TO_SYS(HPH_KEY_INT),
                         {
                                 .direction              = PM_GPIO_DIR_IN,
                                 .pull                   = PM_GPIO_PULL_UP_30,
                                 .vin_sel                = 2,
                 ...
                 { /* WCA_AUDIO_RESET_N -GPIO21 */
                         PM8058_GPIO_PM_TO_SYS(WCA_AUDIO_RESET_N),
                         {
                 ...
                 { /* MICRO_SD_CARD_DETECT_N - GPIO22*/
                         PM8058_GPIO_PM_TO_SYS(MICRO_SD_CARD_DETECT_N),
                         {
                                 .direction              = PM_GPIO_DIR_IN,
                                 .pull                   = PM_GPIO_PULL_UP_30,
                                 .vin_sel                = 2,
                ...
                { /* PMIC_SSBI_CLK - GPIO39*/
                         PM8058_GPIO_PM_TO_SYS(PMIC_SSBI_CLK),
                         {
                                 .direction              = PM_GPIO_DIR_IN,
                                 .pull                   = PM_GPIO_PULL_NO,
                                 .vin_sel                = 2,
...
#if defined(CONFIG_LGE_VIBRATOR) || defined(CONFIG_ANDROID_VIBRATOR) || defined(CONFIG_LGE_ISA1200)
#if 0 /*                                                                       */
