...
#if !defined(CONFIG_MACH_LGE_IJB_BOARD_SKT) && !defined(CONFIG_MACH_LGE_IJB_BOARD_LGU) // use linear scale mapping for I-JB  
...
#define MIN_LEVEL 			0x0F	//0x00
#define DEFAULT_LEVEL			0x55	//0x33
